...
class CoursesBank(models.Model):
    ...
    rub_buy = models.DecimalField(verbose_name='курс покупки рос.рубли', max_digits=2, decimal_places=2)
    rub_sale = models.DecimalField(verbose_name='курс продажи рос.рубли', max_digits=2, decimal_places=2)
